...
/*   Updated: 2022/05/24 21:25:10 by bbonaldi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	print_args(t_format_opt **format_opt, va_list list_args)
{
	...
	if (specifier == 'c')
		ft_print_char(list_args, &number_chars_printed);
	else if (specifier == 's')
		ft_print_str(list_args, &number_chars_printed);
	else if (specifier == 'd' || specifier == 'i')
		ft_print_int(list_args, &number_chars_printed);
	else if (specifier == 'u')
		ft_print_uint(list_args, specifier, &number_chars_printed);
	else if (specifier == 'p')
		ft_print_ptr(list_args, specifier, &number_chars_printed);
	else if (specifier == 'x' || specifier == 'X')
		ft_print_hex(list_args, specifier, &number_chars_printed);
	else if (specifier == '%')
